...
questions[0] = 'How many MUs did <img src="symbols/A.png" class="small"> spend for assigning DPs?';
questions[1] = 'How many DPs did <img src="symbols/E.png" class="small"> receive from <img src="symbols/C.png" class="small">?';
questions[2] = 'How many DPs did <img src="symbols/B.png" class="small"> assign to <img src="symbols/A.png" class="small">?';
questions[3] = 'How many MUs did <img src="symbols/D.png" class="small"> lose, because of receiving DPs from <img src="symbols/A.png" class="small">?';
questions[4] = 'How many DPs did <img src="symbols/E.png" class="small"> receive in total from all group members?';
questions[5] = 'How many MUs did <img src="symbols/B.png" class="small"> lose in total through receiving DPs?';
questions[6] = 'How many DPs can each group member maximally assign to another group member?';
questions[7] = 'How many MUs does it cost to assign one DP?';


answers = new Array(16,2,8,10,6,0,10,1);
...
function show(flag) {
     ...
     setTimeout(function() {
          ...
          ded1 = new Array(0,0,6,10,0);
          ded2 = new Array(8,0,0,0,0);
          ded3 = new Array(0,0,0,0,2);
          ded4 = new Array(0,0,0,0,4);
          ded5 = new Array(2,0,0,0,0);
          ...
          //console.error(((total / (maxDPs*player) * 100) * width/100));
...
function check() {
     ...
     else {    window.location.href = "4_transition.html" + "?cub=" + cubicle + "&tr=" + 2;     }
